...
class REALSENSEPLUGIN_API ARealSenseSessionManager : public AActor
{
	GENERATED_BODY()
...
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ Hand tracking accesor ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
public:
	inline int32 GetHandCount() const { return impl->GetHandCount(); }

	inline FRealSenseHand GetRealSenseHandLeft() { return impl->GetRealSenseHandLeft(); }
	inline FRealSenseHand GetRealSenseHandRight() { return impl->GetRealSenseHandRight(); }


private:
	//std::unique_ptr<RealSenseImpl> impl;
	TSharedPtr<RealSenseImpl> impl;
